...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wpapi/node_modules/wpapi/lib/mixins/parameters.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wpapi/node_modules/wpapi/lib/mixins/parameters.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wpapi/node_modules/wpapi/lib/mixins/</a> &#187; parameters.js</div>
</div>
<div class="body">
 ...
 */
parameterMixins.author = <span class="fstat-no" title="function not covered" >function( author ) {</span>
	/* jshint validthis:true */
<span class="cstat-no" title="statement not covered" >	if ( author === undefined ) {</span>
<span class="cstat-no" title="statement not covered" >		return this;</span>
	}
<span class="cstat-no" title="statement not covered" >	if ( typeof author === 'string' ) {</span>
<span class="cstat-no" title="statement not covered" >		this.param( 'author', null );</span>
<span class="cstat-no" title="statement not covered" >		return filter.call( this, 'author_name', author );</span>
	}
<span class="cstat-no" title="statement not covered" >	if ( typeof author === 'number' ) {</span>
<span class="cstat-no" title="statement not covered" >		filter.call( this, 'author_name', null );</span>
<span class="cstat-no" title="statement not covered" >		return this.param( 'author', author );</span>
	}
<span class="cstat-no" title="statement not covered" >	if ( author === null ) {</span>
<span class="cstat-no" title="statement not covered" >		filter.call( this, 'author_name', null );</span>
<span class="cstat-no" title="statement not covered" >		return this.param( 'author', null );</span>
	}
<span class="cstat-no" title="statement not covered" >	throw new Error( 'author must be either a nicename string or numeric ID' );</span>
};
&nbsp;
/**
 ...
 * @return The request instance (for chaining)
 */
parameterMixins.category = <span class="fstat-no" title="function not covered" >function( category ) {</span>
	/* jshint validthis:true */
<span class="cstat-no" title="statement not covered" >	if ( argumentIsNumeric( category ) ) {</span>
<span class="cstat-no" title="statement not covered" >		return parameterMixins.categories.call( this, category );</span>
	}
<span class="cstat-no" title="statement not covered" >	return taxonomy.call( this, 'category', category );</span>
};
&nbsp;
/**
 ...
 * @return The request instance (for chaining)
 */
parameterMixins.tag = <span class="fstat-no" title="function not covered" >function( tag ) {</span>
	/* jshint validthis:true */
<span class="cstat-no" title="statement not covered" >	if ( argumentIsNumeric( tag ) ) {</span>
<span class="cstat-no" title="statement not covered" >		return parameterMixins.tags.call( this, tag );</span>
	}
<span class="cstat-no" title="statement not covered" >	return taxonomy.call( this, 'tag', tag );</span>
};
&nbsp;
/**
 ...
 * @return The request instance (for chaining)
 */
parameterMixins.before = <span class="fstat-no" title="function not covered" >function( date ) {</span>
	/* jshint validthis:true */
<span class="cstat-no" title="statement not covered" >	return this.param( 'before', new Date( date ).toISOString() );</span>
};
&nbsp;
/**
 ...
 * @return The request instance (for chaining)
 */
parameterMixins.after = <span class="fstat-no" title="function not covered" >function( date ) {</span>
	/* jshint validthis:true */
<span class="cstat-no" title="statement not covered" >	return this.param( 'after', new Date( date ).toISOString() );</span>
};
&nbsp;
