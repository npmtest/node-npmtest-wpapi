...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wpapi/node_modules/wpapi/lib/route-tree.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wpapi/node_modules/wpapi/lib/route-tree.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wpapi/node_modules/wpapi/lib/</a> &#187; route-tree.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function reduceRouteComponents( routeObj, topLevel, parentLevel, component, idx, components ) {</span>
	...
	// ]
<span class="cstat-no" title="statement not covered" >	var namedGroup = component.match( namedGroupRegexp );</span>
...
<span class="cstat-no" title="statement not covered" >	var groupName = namedGroup &amp;&amp; namedGroup[ 1 ];</span>
<span class="cstat-no" title="statement not covered" >	var groupPattern = namedGroup &amp;&amp; namedGroup[ 2 ];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	var levelKey = namedGroup ? ( groupPattern || groupName ) : component;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	var levelName = namedGroup ? groupName : component;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	var currentLevel = parentLevel[ levelKey ] || {</span>
		component: component,
...
<span class="cstat-no" title="statement not covered" >	if ( currentLevel.names.indexOf( levelName ) &lt; 0 ) {</span>
<span class="cstat-no" title="statement not covered" >		currentLevel.names.push( levelName );</span>
	}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	var groupPatternRE = groupPattern === '' ?</span>
...
<span class="cstat-no" title="statement not covered" >	currentLevel.validate = <span class="fstat-no" title="function not covered" >function( input ) {</span></span>
<span class="cstat-no" title="statement not covered" >		return groupPatternRE.test( input );</span>
	};
&nbsp;
	// Check to see whether to expect more nodes within this branch of the tree,
<span class="cstat-no" title="statement not covered" >	if ( components[ idx + 1 ] ) {</span>
		// and create a "children" object to hold those nodes if necessary
<span class="cstat-no" title="statement not covered" >		currentLevel.children = currentLevel.children || {};</span>
	} else {
		// At leaf nodes, specify the method capabilities of this endpoint
<span class="cstat-no" title="statement not covered" >		currentLevel.methods = ( routeObj.methods || [] ).map(<span class="fstat-no" title="function not covered" >function( str ) {</span></span>
...
<span class="cstat-no" title="statement not covered" >		if ( currentLevel.methods.indexOf( 'get' ) &gt; -1 &amp;&amp; currentLevel.methods.indexOf( 'head' ) === -1 ) {</span>
<span class="cstat-no" title="statement not covered" >			currentLevel.methods.push( 'head' );</span>
		}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		if ( routeObj.endpoints ) {</span>
<span class="cstat-no" title="statement not covered" >			topLevel._getArgs = topLevel._getArgs || {};</span>
<span class="cstat-no" title="statement not covered" >			routeObj.endpoints.forEach(<span class="fstat-no" title="function not covered" >function( endpoint ) {</span></span>
...
<span class="cstat-no" title="statement not covered" >				endpoint.methods.forEach(<span class="fstat-no" title="function not covered" >function( method ) {</span></span>
<span class="cstat-no" title="statement not covered" >					if ( method.toLowerCase() === 'get' ) {</span>
<span class="cstat-no" title="statement not covered" >						Object.keys( endpoint.args ).forEach(<span class="fstat-no" title="function not covered" >function( argKey ) {</span></span>
							// Reference param definition objects in the top _getArgs dictionary
<span class="cstat-no" title="statement not covered" >							topLevel._getArgs[ argKey ] = endpoint.args[ argKey ];</span>
						});
					}
				});
			});
...
<span class="cstat-no" title="statement not covered" >	parentLevel[ levelKey ] = currentLevel;</span>
<span class="cstat-no" title="statement not covered" >	return currentLevel.children;</span>
}
&nbsp;
/**
 *
 ...
 */
<span class="fstat-no" title="function not covered" >function reduceRouteTree( namespaces, routeObj, route ) {</span>
<span class="cstat-no" title="statement not covered" >	var nsForRoute = routeObj.namespace;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	var routeString = route.replace( '/' + nsForRoute + '/', '' );</span>
<span class="cstat-no" title="statement not covered" >	var routeComponents = routeString.split( '/' );</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	if ( ! nsForRoute || '/' + nsForRoute === route || ! routeString ) {</span>
<span class="cstat-no" title="statement not covered" >		return namespaces;</span>
	}
&nbsp;
	// Ensure that the namespace object for this namespace exists
<span class="cstat-no" title="statement not covered" >	ensure( namespaces, nsForRoute, {} );</span>
&nbsp;
	// Get a local reference to namespace object
<span class="cstat-no" title="statement not covered" >	var ns = namespaces[ nsForRoute ];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	var resource = routeComponents[0];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	ensure( ns, resource, {} );</span>
<span class="cstat-no" title="statement not covered" >	var levels = ns[ resource ];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >	routeComponents.reduce( reduceRouteComponents.bind( null, routeObj, levels ), levels );</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	return namespaces;</span>
}
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function buildRouteTree( routes ) {</span>
<span class="cstat-no" title="statement not covered" >	return objectReduce( routes, reduceRouteTree, {} );</span>
}
&nbsp;
module.exports = {
