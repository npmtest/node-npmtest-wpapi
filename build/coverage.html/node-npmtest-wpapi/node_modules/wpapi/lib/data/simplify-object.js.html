...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wpapi/node_modules/wpapi/lib/data/simplify-object.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wpapi/node_modules/wpapi/lib/data/simplify-object.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wpapi/node_modules/wpapi/lib/data/</a> &#187; simplify-object.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function simplifyObject( obj ) {</span>
	// Pass through falsy values, Dates and RegExp values without modification
<span class="cstat-no" title="statement not covered" >	if ( ! obj || obj instanceof Date || obj instanceof RegExp ) {</span>
...
<span class="cstat-no" title="statement not covered" >		return obj.map( simplifyObject );</span>
	}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		return objectReduce( obj, <span class="fstat-no" title="function not covered" >function( newObj, val, key ) {</span></span>
			// Omit _links objects entirely
<span class="cstat-no" title="statement not covered" >			if ( key === '_links' ) {</span>
...
&nbsp;
			...
			// other than "required"
<span class="cstat-no" title="statement not covered" >			if ( key === 'args' ) {</span>
<span class="cstat-no" title="statement not covered" >				newObj.args = objectReduce( val, <span class="fstat-no" title="function not covered" >function( slimArgs, argVal, argKey ) {</span></span>
<span class="cstat-no" title="statement not covered" >					slimArgs[ argKey ] = {};</span>
<span class="cstat-no" title="statement not covered" >					return slimArgs;</span>
				}, {});
			} else {
				// Pass all other objects through simplifyObject
<span class="cstat-no" title="statement not covered" >				newObj[ key ] = simplifyObject( obj[ key ] );</span>
			}
<span class="cstat-no" title="statement not covered" >			return newObj;</span>
		}, {});
	}
