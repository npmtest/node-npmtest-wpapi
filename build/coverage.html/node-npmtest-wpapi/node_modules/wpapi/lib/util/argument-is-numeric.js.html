...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wpapi/node_modules/wpapi/lib/util/argument-is-numeric.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wpapi/node_modules/wpapi/lib/util/argument-is-numeric.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wpapi/node_modules/wpapi/lib/util/</a> &#187; argument-is-numeric.js</div>
</div>
<div class="body">
 ...
 * @returns {void}
 */
<span class="fstat-no" title="function not covered" >function argumentIsNumeric( val ) {</span>
...
<span class="cstat-no" title="statement not covered" >		return /^\d+$/.test( val );</span>
	}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >			if ( ! argumentIsNumeric( val[ i ] ) ) {</span>
